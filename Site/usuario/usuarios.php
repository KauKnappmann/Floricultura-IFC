...
.quatro {
  ...
  <div class="site-wrap">
    ...
    <div class="custom-border-bottom py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="../home.php">Home</a> <span class="mx-2 mb-0">/</span><span class="mx-2 mb-0">administrador</span> <span class="mx-2 mb-0">/</span> <a href="usuarios.php">Usuários</a></div>
        </div>
      </div>
    </div>
  ...
  <tbody>
        ...
        foreach($usuarios as $Usuario){   
           ...
           echo $usuario_sub."<tr><th scope='row'>".$Usuario['cod']."</th><td>".$Usuario['nome']."</td>
           <td>".$Usuario['sobrenome']."</td><td>".$Usuario['email']."</td><td>".$Usuario['genero']."</td>
           <td>".$Usuario['telefone']."</td><td><img style='width: 20px;height: 20px;' src='../Upload/Usuario/".$Usuario['img']."'></td>
